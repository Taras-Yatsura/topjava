...
@NamedQueries({@NamedQuery(name = Meal.ALL_SORTED,
               ...
               @NamedQuery(name = Meal.GET_BETWEEN,
                           query = """
                                   ...
                                   """),
               //        @NamedQuery(name = Meal.UPDATE, query = "UPDATE Meal m SET m.dateTime = :datetime, m
               //        .calories= :calories," +
...
public class Meal extends AbstractBaseEntity
{
    ...
    @Size(min = 2,
          max = 120,
          groups = {ValidatedUI.class, Default.class})
